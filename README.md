...
![Location Map](Location map of the study area.jpg)
...
![Agro Climate](Agro climate map.jpg)
...
![Land Use](Land-use and land-cover map.jpg)
...
![Rainfall Map](Precipitation map.jpg)
...
![Rainfall Trend](Overall rainfall time series with trend.png)
...
![Rainfall Flow](Rainfall vs flood flow scatter plot.jpg)
...
![Flood Trend](Total rainfall and maximum flood flow trends.png)
...
![Return Period](Peak flow vs return period log-log curve.png)
...
![Frequency Models](Frequency models comparison graph.png)
...
![Flood Inundation](Flood inundation area time series and trend.png)
